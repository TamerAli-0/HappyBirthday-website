...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("Awesome!, u finished the game, proud of u :)");
      // this is messy
      this.msgText.html("Now you are going to experience 3D stuff be ready (;");
      this.showMsg();
    ...
    lose: function(){
      ...
      this.msgText.html("Don't worry, TRY AGAIN by reloading the page, or proceed to the 3D page :( ");
      this.showMsg();
    }
